...
gstrBackupBasename = "Fapolicy-analyzer_Backup"


def falogger_cleanup_logs(strBackupBasename):
    logging.debug("falogger_initial_config()")
    pass

def falogger_dbase_cleanup_snapshots(strBackupBasename):
...
def falogger_initial_config(strArchiveFile=None, strListFile=None):
    logging.debug("falogger_initial_config()")
    pass

def falogger_dbase_snapshot(strArchiveFile=None, strListFile=None):
