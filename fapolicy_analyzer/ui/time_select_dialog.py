...
class TimeSelectDialog(UIBuilderWidget):
    ...
    def get_time(self, sos="start"):
        time_dict = {
                    sos + "Minute": self.get_object(sos + "Minute").get_value_as_int(),
