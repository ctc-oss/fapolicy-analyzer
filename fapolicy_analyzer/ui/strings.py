...
PROF_ARG_EXEC_EMPTY = _("Error: executeText field is empty")
PROF_ARG_EXEC_DOESNT_EXIST = _("Error: {} does not exist.")
PROF_ARG_EXEC_NOT_EXECUTABLE = _("Error: {} is not executable")
PROF_ARG_USER_DOESNT_EXIST = _("Error: User {} does not exist")
PROF_ARG_PWD_DOESNT_EXIST = _("Error: {} does not exist.")
PROF_ARG_PWD_ISNT_DIR = _("Error: {} is not a directory.")
