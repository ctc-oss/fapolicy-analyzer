...
use fapolicy_trust::source::TrustSource::{Ancillary, System};
...
fn trust_status() {
    ...
    trust.put(Rec::from_source(make_trust("/bin/bash"), System));
    trust.put(Rec::from_source(make_trust("/foo/bar"), Ancillary));
